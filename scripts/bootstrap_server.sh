...
echo "   systemctl disable ssh.socket --now"
echo "   systemctl enable ssh --now"
echo "   systemctl restart ssh"
echo ""
echo " NOTA: Ubuntu 22.04 usa socket activation (ssh.socket) por defecto."
echo " Sin deshabilitar ssh.socket primero, el restart detiene SSH sin arrancarlo."
echo ""
